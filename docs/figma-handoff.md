...
|------|------|
| 프로젝트명 | SoftPuzzle PM |
| 버전 | v1.0 (12~13단계 핸드오프) |
| 작성일 | 2026-05-21 |
| 기준 | 프로토타입(`prototype/index.html`, Gate 11 컨펌) · 화면 설계서(`screen-design/` v1.5) |
| 단계 | 12 Figma 핸드오프 등록 → 13 Figma 컨펌(Gate 13, REQ-DSN-004) |
...
- **범위**: 프로토타입 v2(Gate 11 컨펌)의 디자인 시스템과 31개 화면/모달. 새 디자인이 아니라 **확정 프로토타입의 Figma 정제본**.
...
> 13단계에서 고객사 컨펌(Gate 13) 통과가 개발(14) 사전조건. 라이브 Figma URL 가변성은 버전 링크로 완화(강제 불가). 프로토타입 figma 슬롯이 이 묶음을 시연.
